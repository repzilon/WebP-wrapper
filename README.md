...
The wrapper is in safe managed code in one class. No need for external dll except libwebp_x86.dll (included v0.4.4) and libwebp_x64.dll (included v1.0.3). The wrapper works in 32, 64 bit or ANY (auto switch to the appropiate library).
